...
int main()
{
	...
	if(s == -1 )
	{
	    ...
	    add=lower_bound(v.begin(),v.end(),m);
	    int pos=add-v.begin();
	    cout<<"The element will be added at positon no: "<<pos<<endl;
	    v.push_back(m);
	    sort(v.begin(),v.end());
	    cout<<"The new array after adding the number is: ";
	...
	else
	{
		...
		v.erase(v.begin()+s);
		cout<<"The array after removal of the element is: ";
		for(it=v.begin();it<v.end();it++)
		{
			cout<<*it<<" ";
		}
